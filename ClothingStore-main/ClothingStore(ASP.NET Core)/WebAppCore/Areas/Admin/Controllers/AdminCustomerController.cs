...
namespace WebAppCore.Areas.Admin.Controllers
{
    [Area("Admin")]
    [Route("AdminCustomer")]
    [Route("Admin/AdminCustomerAdmin")]
    public class AdminCustomerController : Controller
    {
        private readonly SqlwebchivalryContext _context;

        public AdminCustomerController(SqlwebchivalryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Customers != null ?
                        ...
                        Problem("Entity set 'SqlwebchivalryContext.Customers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SqlwebchivalryContext.Customers'  is null.");
            }
            var customer = await _context.Customers.FindAsync(id);
            if (customer != null)
            {
